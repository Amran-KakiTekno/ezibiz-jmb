      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="p-5 rounded-2xl bg-white dark:bg-zinc-950/80 border border-slate-200 dark:border-white/[0.08] shadow-rim">
          ...
          <div className="flex items-baseline gap-2">
            ...
            <span className="text-xs text-slate-400 dark:text-slate-400">({paidUnits}/{totalUnits} Petak)</span>
          </div>
          ...
          <div className="space-y-4">
            <div className="p-4 rounded-xl bg-slate-50 dark:bg-zinc-900/60 border border-slate-200 dark:border-white/[0.08] shadow-rim space-y-2">
              ...
              <p className="text-[11px] text-slate-500 dark:text-zinc-400">
                Maybank Islamic (No: 5641 2890 1142) â€¢ Khusus untuk kos operasi bulanan: gaji pengawal keselamatan, bil elektrik TNB, dan pencucian lif.
              </p>
            </div>
            ...
            <div className="p-4 rounded-xl bg-slate-50 dark:bg-zinc-900/60 border border-slate-200 dark:border-white/[0.08] shadow-rim space-y-2">
              ...
              <p className="text-[11px] text-slate-500 dark:text-zinc-400">
                CIMB Islamic (No: 8604 1993 7701) â€¢ Rizab modal khas untuk mengecat bangunan, penggantian pam air booster, dan overhauls kabel lif.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-3 text-xs">
            <div className="flex items-center justify-between p-3 rounded-xl bg-slate-50 dark:bg-zinc-900/60 border border-slate-200 dark:border-white/[0.08] shadow-rim">
              <div>
                ...
                <p className="text-[11px] text-slate-500 dark:text-slate-400">Peringatan automatik WhatsApp</p>
              </div>
              <span className="font-mono tabular-nums font-semibold text-slate-700 dark:text-zinc-300">2 Unit â€¢ RM 792.00</span>
            </div>

            <div className="flex items-center justify-between p-3 rounded-xl bg-slate-50 dark:bg-zinc-900/60 border border-slate-200 dark:border-white/[0.08] shadow-rim">
              <div>
                <span className="font-semibold text-amber-700 dark:text-amber-400">31 - 60 Hari (Peringatan Rasmi)</span>
                <p className="text-[11px] text-slate-500 dark:text-slate-400">Faedah lewat 10% p.a. mula dikenakan</p>
              </div>
              <span className="font-mono tabular-nums font-semibold text-amber-700 dark:text-amber-400">1 Unit â€¢ RM 776.16</span>
            </div>
            ...
            <div className="flex items-center justify-between p-3 rounded-xl bg-rose-50 dark:bg-zinc-900/60 border border-rose-500/30 dark:bg-rose-500/5 shadow-rim">
              ...
              <span className="font-mono tabular-nums font-semibold text-rose-700 dark:text-rose-400">2 Unit â€¢ RM 2,446.40</span>
            </div>
          </div>
        </div>
      </div>
